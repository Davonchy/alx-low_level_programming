 ...
 * @e_ident: A pointer an array of ELF magic numbers.
 *
 ...
 * @e_ident: A pointer to the array of ELF class.
 */
void print_class(unsigned char *e_ident)
{
printf(" Class:                            ");
 ...
 * @e_ident: A pointer to an of ELF class.
 */
void print_data(unsigned char *e_ident)
{
printf(" Data:                             ");
 ...
 * @e_ident: A pointer to an ELF array version.
 */
void print_version(unsigned char *e_ident)
{
printf(" Version:                          %d",
