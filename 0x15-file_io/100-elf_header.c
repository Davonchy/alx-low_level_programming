 ...
 * @e_id: A pointer an array of ELF magic numbers.
 *
 ...
 * @e_id: A pointer to the array of ELF class.
 */
void print_class(unsigned char *e_id)
{
printf(" Class:                            ");
 ...
 * @e_id: A pointer to an of ELF class.
 */
void print_data(unsigned char *e_id)
{
printf(" Data:                             ");
 ...
 * @e_id: A pointer to an ELF array version.
 */
void print_version(unsigned char *e_id)
{
printf(" Version:                          %d",
...
/**
 * print - Prints the OS/ABI of an ELF header.
 * @e_id: A pointer to an array of ELF version.
 */
void print_osabi(unsigned char *e_id)
{
printf(" OS/ABI:                            ");
